...
P = {"model":"openai/gpt-4o-mini","messages":[{"role":"user","content":"scrivi: ok"}]}
r = requests.post("https://openrouter.ai/api/v1/chat/completions", headers=H, json=P, timeout=60)
